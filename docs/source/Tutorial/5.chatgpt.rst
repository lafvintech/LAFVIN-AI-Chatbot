...
4. Connect the development board to your computer using the correct USB Type-C port for your operating system, as described in the note above.
...
For flashing help, driver troubleshooting, or alternative flashing methods, see :ref:`Online Flasher <online_flasher>`.
