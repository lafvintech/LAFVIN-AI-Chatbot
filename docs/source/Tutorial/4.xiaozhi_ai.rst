...
Follow these steps:
   ...
   C. Connect the development board to your computer using a Type-C cable. Click ``Connect``, then select your device in the browser pop-up window and click connect.
...
5. Select your Wi-Fi network and enter the password to connect
6. The board will automatically restart, connect to your Wi-Fi, and announce a 6-digit verification code
