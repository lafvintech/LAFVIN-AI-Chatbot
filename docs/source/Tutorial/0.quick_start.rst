...
If you want to use the ChatGPT firmware, please refer to :doc:`ChatGPT Tutorial </Tutorial/5.chatgpt>` for the remaining firmware flashing and configuration steps.
...
* :doc:`ChatGPT Setup </Tutorial/5.chatgpt>`
